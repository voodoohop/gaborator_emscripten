...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'wrap_gaborator.wast';
  var wasmBinaryFile = 'wrap_gaborator.wasm';
  var asmjsCodeFile = 'wrap_gaborator.temp.asm.js';
...
function nullFunc_viiiijj(x) { Module["printErr"]("Invalid function pointer called with signature 'viiiijj'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)");  Module["printErr"]("Build with ASSERTIONS=2 for more info.");abort(x) }

function nullFunc_viijii(x) { Module["printErr"]("Invalid function pointer called with signature 'viijii'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)");  Module["printErr"]("Build with ASSERTIONS=2 for more info.");abort(x) }

Module['wasmTableSize'] = 8353;

Module['wasmMaxTableSize'] = 8353;
...
var real___GLOBAL__sub_I_wrap_gaborator_cc = asm["__GLOBAL__sub_I_wrap_gaborator_cc"]; asm["__GLOBAL__sub_I_wrap_gaborator_cc"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___GLOBAL__sub_I_wrap_gaborator_cc.apply(null, arguments);
};
...
var __GLOBAL__sub_I_wrap_gaborator_cc = Module["__GLOBAL__sub_I_wrap_gaborator_cc"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_wrap_gaborator_cc"].apply(null, arguments) };
